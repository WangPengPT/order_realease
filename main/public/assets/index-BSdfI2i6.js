import{B as X,c as a,e as h,o as r,d as p,f as y,m as o,g as L,t as O,ah as x,al as oe,an as re,aj as ae,ak as G,ao as $,ap as de,Y as ce,I as ue,v as pe,D as he,S as fe,N as V,aq as me,ar as be,am as ge,as as M,r as I,M as ye,a as v,b as K,F as D,C as E,E as q,w as S,z as k,T as ve,af as Oe,at as Ie,y as Se}from"./index-BxEdevYS.js";import{b as ke,a as we,s as Le,x as j}from"./index-H5xuy8zQ.js";import{C as Ce,O as Fe}from"./index-BtEo18XN.js";import{b as xe,c as Ve,d as Ke,s as Te}from"./index-cE0vUSAY.js";import{c as Me,f as P,d as De,R as Ae}from"./index-JqOmmvEi.js";import{s as Ee}from"./index-D6NnwwCO.js";import{a as Pe,s as ze}from"./index-BfaWA40Q.js";import{s as Re,a as He}from"./index-B4ua0aJA.js";var Be=`
    .p-chip {
        display: inline-flex;
        align-items: center;
...
`,Ge={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},$e=X.extend({name:"chip",style:Be,classes:Ge}),Ne={name:"BaseChip",extends:Me,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:$e,provide:function(){return{$pcChip:this,$parentInstance:this}}},Z={name:"Chip",extends:Ne,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key==="Enter"||e.key==="Backspace")&&this.close(e)},close:function(e){this.visible=!1,this.$emit("remove",e)}},computed:{dataP:function(){return P({removable:this.removable})}},components:{TimesCircleIcon:Ee}},je=["aria-label","data-p"],Ue=["src"];function qe(t,e,i,l,s,n){return s.visible?(r(),a("div",o({key:0,class:t.cx("root"),"aria-label":t.label},t.ptmi("root"),{"data-p":n.dataP}),[p(t.$slots,"default",{},function(){return[t.image?(r(),a("img",o({key:0,src:t.image},t.ptm("image"),{class:t.cx("image")}),null,16,Ue)):t.$slots.icon?(r(),y(L(t.$slots.icon),o({key:1,class:t.cx("icon")},t.ptm("icon")),null,16,["class"])):t.icon?(r(),a("span",o({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon")),null,16)):h("",!0),t.label!==null?(r(),a("div",o({key:3,class:t.cx("label")},t.ptm("label")),O(t.label),17)):h("",!0)]}),t.removable?p(t.$slots,"removeicon",{key:0,removeCallback:n.close,keydownCallback:n.onKeydown},function(){return[(r(),y(L(t.removeIcon?"span":"TimesCircleIcon"),o({class:[t.cx("removeIcon"),t.removeIcon],onClick:n.close,onKeydown:n.onKeydown},t.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):h("",!0)],16,je)):h("",!0)}Z.render=qe;var We=`
    .p-multiselect {
        display: inline-flex;
        cursor: pointer;
        position: relative;
