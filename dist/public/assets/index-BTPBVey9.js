import{B as Z,c as a,e as h,o as r,r as p,f as y,m as o,g as L,t as O,L as x,M as oe,N as re,O as ae,P as G,Q as $,U as de,Y as ce,I as ue,v as pe,D as he,S as fe,V,W as me,X as be,Z as ge,_ as M,b as I,$ as ye,a as v,d as K,F as D,C as E,E as q,w as S,z as k,T as ve,a0 as Oe,a1 as Ie,y as Se}from"./index-wgRpoX0d.js";import{s as ke,x as U}from"./index-D-07fRNA.js";import{C as we,O as Le}from"./index-aCXqh-i3.js";import{s as Ce}from"./index-BSRB7VuG.js";import{s as Fe}from"./index-Dnq2afyk.js";import{d as xe,e as Ve,b as Ke}from"./index-CvOoD4gH.js";import{s as Te,f as P,d as Me,R as De}from"./index-B_yOoGes.js";import{s as Ae}from"./index-CpkBTmvN.js";import{s as Ee}from"./index-CS9HPE5f.js";import{a as Pe,s as ze}from"./index-Cwyqkitp.js";import{s as Re,a as He}from"./index-Cp6jjMOu.js";var Be=`
    .p-chip {
        display: inline-flex;
        align-items: center;
...
`,Ge={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},$e=Z.extend({name:"chip",style:Be,classes:Ge}),Ne={name:"BaseChip",extends:Te,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:$e,provide:function(){return{$pcChip:this,$parentInstance:this}}},J={name:"Chip",extends:Ne,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(e){(e.key==="Enter"||e.key==="Backspace")&&this.close(e)},close:function(e){this.visible=!1,this.$emit("remove",e)}},computed:{dataP:function(){return P({removable:this.removable})}},components:{TimesCircleIcon:Ee}},Ue=["aria-label","data-p"],je=["src"];function qe(t,e,i,l,s,n){return s.visible?(r(),a("div",o({key:0,class:t.cx("root"),"aria-label":t.label},t.ptmi("root"),{"data-p":n.dataP}),[p(t.$slots,"default",{},function(){return[t.image?(r(),a("img",o({key:0,src:t.image},t.ptm("image"),{class:t.cx("image")}),null,16,je)):t.$slots.icon?(r(),y(L(t.$slots.icon),o({key:1,class:t.cx("icon")},t.ptm("icon")),null,16,["class"])):t.icon?(r(),a("span",o({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon")),null,16)):h("",!0),t.label!==null?(r(),a("div",o({key:3,class:t.cx("label")},t.ptm("label")),O(t.label),17)):h("",!0)]}),t.removable?p(t.$slots,"removeicon",{key:0,removeCallback:n.close,keydownCallback:n.onKeydown},function(){return[(r(),y(L(t.removeIcon?"span":"TimesCircleIcon"),o({class:[t.cx("removeIcon"),t.removeIcon],onClick:n.close,onKeydown:n.onKeydown},t.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):h("",!0)],16,Ue)):h("",!0)}J.render=qe;var We=`
    .p-multiselect {
        display: inline-flex;
        cursor: pointer;
        position: relative;
