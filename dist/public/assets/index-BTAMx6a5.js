...
`,Pt={root:function(t){var e=t.props,n=t.instance;return["p-badge p-component",{"p-badge-circle":F(e.value)&&String(e.value).length===1,"p-badge-dot":U(e.value)&&!n.$slots.default,"p-badge-sm":e.size==="small","p-badge-lg":e.size==="large","p-badge-xl":e.size==="xlarge","p-badge-info":e.severity==="info","p-badge-success":e.severity==="success","p-badge-warn":e.severity==="warn","p-badge-danger":e.severity==="danger","p-badge-secondary":e.severity==="secondary","p-badge-contrast":e.severity==="contrast"}]}},Ct=B.extend({name:"badge",style:_t,classes:Pt}),Ft={name:"BaseBadge",extends:Z,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:Ct,provide:function(){return{$pcBadge:this,$parentInstance:this}}};function x(o){"@babel/helpers - typeof";return x=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(t){return typeof t}:function(t){return t&&typeof Symbol=="function"&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},x(o)}function N(o,t,e){return(t=Et(t))in o?Object.defineProperty(o,t,{value:e,enumerable:!0,configurable:!0,writable:!0}):o[t]=e,o}function Et(o){var t=jt(o,"string");return x(t)=="symbol"?t:t+""}function jt(o,t){if(x(o)!="object"||!o)return o;var e=o[Symbol.toPrimitive];if(e!==void 0){var n=e.call(o,t);if(x(n)!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(t==="string"?String:Number)(o)}var G={name:"Badge",extends:Ft,inheritAttrs:!1,computed:{dataP:function(){return C(N(N({circle:this.value!=null&&String(this.value).length===1,empty:this.value==null&&!this.$slots.default},this.severity,this.severity),this.size,this.size))}}},Ot=["data-p"];function zt(o,t,e,n,r,a){return g(),E("span",c({class:o.cx("root"),"data-p":a.dataP},o.ptmi("root")),[m(o.$slots,"default",{},function(){return[Y(q(o.value),1)]})],16,Ot)}G.render=zt;var Bt=V`
    .p-button {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
