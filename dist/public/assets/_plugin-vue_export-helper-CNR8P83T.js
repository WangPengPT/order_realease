...
`,Zt={root:function(e){var o=e.props,r=e.instance;return["p-badge p-component",{"p-badge-circle":ft(o.value)&&String(o.value).length===1,"p-badge-dot":_(o.value)&&!r.$slots.default,"p-badge-sm":o.size==="small","p-badge-lg":o.size==="large","p-badge-xl":o.size==="xlarge","p-badge-info":o.severity==="info","p-badge-success":o.severity==="success","p-badge-warn":o.severity==="warn","p-badge-danger":o.severity==="danger","p-badge-secondary":o.severity==="secondary","p-badge-contrast":o.severity==="contrast"}]}},Wt=$.extend({name:"badge",style:Vt,classes:Zt}),qt={name:"BaseBadge",extends:x,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:Wt,provide:function(){return{$pcBadge:this,$parentInstance:this}}};function T(t){"@babel/helpers - typeof";return T=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},T(t)}function X(t,e,o){return(e=Jt(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function Jt(t){var e=Qt(t,"string");return T(e)=="symbol"?e:e+""}function Qt(t,e){if(T(t)!="object"||!t)return t;var o=t[Symbol.toPrimitive];if(o!==void 0){var r=o.call(t,e);if(T(r)!="object")return r;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}var ot={name:"Badge",extends:qt,inheritAttrs:!1,computed:{dataP:function(){return C(X(X({circle:this.value!=null&&String(this.value).length===1,empty:this.value==null&&!this.$slots.default},this.severity,this.severity),this.size,this.size))}}},Xt=["data-p"];function Yt(t,e,o,r,d,n){return a(),l("span",i({class:t.cx("root"),"data-p":n.dataP},t.ptmi("root")),[p(t.$slots,"default",{},function(){return[G(K(t.value),1)]})],16,Xt)}ot.render=Yt;var Gt=F`
    .p-button {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
