import{y as v,B as y,R as $,A as x,av as f,U as z,K as w,g as c,s as g,i as h,D as m,p as S,j as P,E as i,t as I,r as p,c as D}from"./index-DPvrtvT6.js";import{c as B,b as T}from"./index-CBqBaMru.js";var L=v`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`,q={root:function(e){var o=e.instance,n=e.props;return["p-togglebutton p-component",{"p-togglebutton-checked":o.active,"p-invalid":o.$invalid,"p-togglebutton-sm p-inputfield-sm":n.size==="small","p-togglebutton-lg p-inputfield-lg":n.size==="large"}]},content:"p-togglebutton-content",icon:"p-togglebutton-icon",label:"p-togglebutton-label"},A=y.extend({name:"togglebutton",style:L,classes:q}),C={name:"BaseToggleButton",extends:B,props:{onIcon:String,offIcon:String,onLabel:{type:String,default:"Yes"},offLabel:{type:String,default:"No"},iconPos:{type:String,default:"left"},readonly:{type:Boolean,default:!1},tabindex:{type:Number,default:null},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null},size:{type:String,default:null}},style:A,provide:function(){return{$pcToggleButton:this,$parentInstance:this}}};function l(t){"@babel/helpers - typeof";return l=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},l(t)}function N(t,e,o){return(e=O(e))in t?Object.defineProperty(t,e,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[e]=o,t}function O(t){var e=j(t,"string");return l(e)=="symbol"?e:e+""}function j(t,e){if(l(t)!="object"||!t)return t;var o=t[Symbol.toPrimitive];if(o!==void 0){var n=o.call(t,e);if(l(n)!="object")return n;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}var R={name:"ToggleButton",extends:C,inheritAttrs:!1,emits:["change"],methods:{getPTOptions:function(e){var o=e==="root"?this.ptmi:this.ptm;return o(e,{context:{active:this.active,disabled:this.disabled}})},onChange:function(e){!this.disabled&&!this.readonly&&(this.writeValue(!this.d_value,e),this.$emit("change",e))},onBlur:function(e){var o,n;(o=(n=this.formField).onBlur)===null||o===void 0||o.call(n,e)}},computed:{active:function(){return this.d_value===!0},hasLabel:function(){return f(this.onLabel)&&f(this.offLabel)},label:function(){return this.hasLabel?this.d_value?this.onLabel:this.offLabel:" "},dataP:function(){return x(N({checked:this.active,invalid:this.$invalid},this.size,this.size))}},directives:{ripple:$}},F=["tabindex","disabled","aria-pressed","aria-label","aria-labelledby","data-p-checked","data-p-disabled","data-p"],E=["data-p"];function U(t,e,o,n,s,a){var k=z("ripple");return w((g(),c("button",i({type:"button",class:t.cx("root"),tabindex:t.tabindex,disabled:t.disabled,"aria-pressed":t.d_value,onClick:e[0]||(e[0]=function(){return a.onChange&&a.onChange.apply(a,arguments)}),onBlur:e[1]||(e[1]=function(){return a.onBlur&&a.onBlur.apply(a,arguments)})},a.getPTOptions("root"),{"aria-label":t.ariaLabel,"aria-labelledby":t.ariaLabelledby,"data-p-checked":a.active,"data-p-disabled":t.disabled,"data-p":a.dataP}),[h("span",i({class:t.cx("content")},a.getPTOptions("content"),{"data-p":a.dataP}),[m(t.$slots,"default",{},function(){return[m(t.$slots,"icon",{value:t.d_value,class:S(t.cx("icon"))},function(){return[t.onIcon||t.offIcon?(g(),c("span",i({key:0,class:[t.cx("icon"),t.d_value?t.onIcon:t.offIcon]},a.getPTOptions("icon")),null,16)):P("",!0)]}),h("span",i({class:t.cx("label")},a.getPTOptions("label")),I(a.label),17)]})],16,E)],16,F)),[[k]])}R.render=U;const b=p([]),u=p([]),V=t=>{b.value.length=0;for(let e=0;e<t.length;e++)b.value.push(t[e])};function H(){const t=[];for(const e of u.value)if(e.name!="Descontos")for(const o of e.mainDishes){o.dish.quantity>0&&t.push(o.dish);for(const n of o.subItems)n.quantity>0&&(n.name=o.dish.name,n.image=o.dish.image,t.push(n))}return t}function K(t){const e=[];for(const o of t)e.push({id:o.id,quantity:o.quantity});return e}function M(t){if(Array.isArray(t))for(const e of t)for(const o of u.value)for(const n of o.mainDishes){n.dish.id===e.id&&n.subItems.length===0&&(n.dish.quantity=e.quantity);for(const s of n.subItems)s.id===e.id&&(s.quantity=e.quantity)}}function Q(){for(const t of u.value)for(const e of t.mainDishes){e.dish.quantity=0;for(const o of e.subItems)o.quantity=0}}const Y={dishDatas:u,dishes:b,showDishList:V,getAllIncrementedDish:H,updateDishDataQty:M,cleanDishDataQty:Q,getIdsAndQuantity:K},r=p([]),G=D(()=>{const t=r.value.length,e=Y.dishDatas.value.flatMap(o=>o.name=="Descontos"?[]:o.mainDishes).flatMap(o=>[o.dish,...o.subItems.map(n=>({...n,parentName:o.dish.name,parentImage:o.dish.image}))]).filter(o=>o.quantity>0).reduce((o,n)=>o+n.quantity,0);return t+e});function J(t){t.id=X(),r.value.push(t)}function W(t){for(let e=0;e<r.value.length;e++)if(r.value[e].id==t.id){r.value.splice(e,1);break}}function X(){const t=Date.now().toString(36),e=Math.random().toString(36).substring(2,5);return`${t}-${e}`}function Z(){r.value=[]}const ct={addItem:J,removeItem:W,cartDishs:r,cartItemCount:G,cleanAll:Z};var _=v`
    .p-textarea {
        font-family: inherit;
        font-feature-settings: inherit;
        font-size: 1rem;
