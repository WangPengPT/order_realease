import{a as m,u as d,b as p}from"./vendor-query-D82cqPtt.js";import{u as h,s as i,aG as n}from"./index-wnyfSufX.js";import{u as l}from"./vendor-i18n-DxKeo2S1.js";const q=()=>m({queryKey:["shop-items"],queryFn:async()=>{const{data:e,error:r}=await i.from("shop_items").select(`
          *,
          coupon_templates (
            id,
            title_zh,
...
//# sourceMappingURL=useShopItems-DiJj_3C0.js.map
