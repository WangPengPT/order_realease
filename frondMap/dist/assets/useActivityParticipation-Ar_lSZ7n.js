import{p as d,x as _,s as n,o as p,ac as l,af as m,a2 as u}from"./index-DDDDgwLZ.js";const f=()=>{const{user:t}=d();return _({queryKey:["merchantRestaurants",t==null?void 0:t.id],queryFn:async()=>{if(!t)return[];const{data:e,error:r}=await n.from("merchant_restaurants").select(`
          restaurant_id,
