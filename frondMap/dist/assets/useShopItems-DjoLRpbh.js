import{y as d,q as h,w as i,u as m,ad as p,ag as l,ac as n}from"./index-Ga7ov3Y-.js";const _=()=>d({queryKey:["shop-items"],queryFn:async()=>{const{data:e,error:r}=await i.from("shop_items").select(`
          *,
          coupon_templates (
            id,
            title_zh,
