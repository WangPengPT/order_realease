import{a as m,u as d,b as p}from"./vendor-query-BS0wY7WL.js";import{n as h,s as i,V as n}from"./index-kEIDKiMZ.js";import{u as l}from"./vendor-i18n-CqcxoxDo.js";const q=()=>m({queryKey:["shop-items"],queryFn:async()=>{const{data:e,error:r}=await i.from("shop_items").select(`
          *,
          coupon_templates (
            id,
            title_zh,
...
//# sourceMappingURL=useShopItems-DxjIc_jT.js.map
