import{s as m,p as d,q as p,v as l}from"./vendor-react-BJ_Fufgb.js";import{u as h,s as i,Y as n}from"./index-BSqTIOKh.js";const f=()=>m({queryKey:["shop-items"],queryFn:async()=>{const{data:e,error:r}=await i.from("shop_items").select(`
          *,
          coupon_templates (
            id,
            title_zh,
...
//# sourceMappingURL=useShopItems-Uy3iF-ca.js.map
