import{s as _,q as m,v as l}from"./vendor-react-DImbKuZP.js";import{i as o}from"./vendor-i18n-AOdgFpXS.js";import{u as c,s as i,I as y}from"./index-EPc0iAS-.js";const f=()=>{const{user:e}=c();return _({queryKey:["merchantRestaurants",e?.id],queryFn:async()=>{if(!e)return[];const{data:a,error:r}=await i.from("merchant_restaurants").select(`
          restaurant_id,
...
//# sourceMappingURL=useActivityParticipation-CUsxC-Lk.js.map
