import{a as _,u as m,b as y}from"./vendor-query-BlSVl3IQ.js";import{i as o}from"./vendor-i18n-DxKeo2S1.js";import{y as c,Q as i,x as l}from"./index-BF1tiRoq.js";const f=()=>{const{user:e}=c();return _({queryKey:["merchantRestaurants",e?.id],queryFn:async()=>{if(!e)return[];const{data:a,error:r}=await i.from("merchant_restaurants").select(`
          restaurant_id,
...
//# sourceMappingURL=useActivityParticipation-C_V_IsYW.js.map
