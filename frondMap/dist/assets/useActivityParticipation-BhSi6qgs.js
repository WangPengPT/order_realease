import{a as _,u as p,b as l}from"./vendor-query-BS0wY7WL.js";import{i as o}from"./vendor-i18n-CqcxoxDo.js";import{n as c,s as i,m as y}from"./index-CEqKPgls.js";const f=()=>{const{user:e}=c();return _({queryKey:["merchantRestaurants",e?.id],queryFn:async()=>{if(!e)return[];const{data:a,error:r}=await i.from("merchant_restaurants").select(`
          restaurant_id,
