import{a as _,u as m,b as l}from"./vendor-query-D82cqPtt.js";import{i as o}from"./vendor-i18n-DxKeo2S1.js";import{u as c,s as i,j as y}from"./index-CcIuifO_.js";const f=()=>{const{user:e}=c();return _({queryKey:["merchantRestaurants",e?.id],queryFn:async()=>{if(!e)return[];const{data:a,error:r}=await i.from("merchant_restaurants").select(`
          restaurant_id,
...
//# sourceMappingURL=useActivityParticipation-DJdxslx5.js.map
