import{A as d,t as h,y as i,u as m,af as p,ai as l,ae as n}from"./index-tBrG_sQo.js";const _=()=>d({queryKey:["shop-items"],queryFn:async()=>{const{data:e,error:r}=await i.from("shop_items").select(`
          *,
          coupon_templates (
            id,
            title_zh,
