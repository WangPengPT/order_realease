import{a as m,u as d,b as p}from"./vendor-query-EnOED-MY.js";import{u as h,s as i,aK as n}from"./index-H22t9J9U.js";import{u as l}from"./vendor-i18n-DWR4v88Y.js";const q=()=>m({queryKey:["shop-items"],queryFn:async()=>{const{data:e,error:r}=await i.from("shop_items").select(`
          *,
          coupon_templates (
            id,
            title_zh,
...
//# sourceMappingURL=useShopItems-DNpHMdJI.js.map
