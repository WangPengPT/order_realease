import{a as _,u as m,b as y}from"./vendor-query-BqhVR-X_.js";import{i as o}from"./vendor-i18n-DxKeo2S1.js";import{a as c,Q as i,y as l}from"./index-DW5TeK8H.js";const f=()=>{const{user:e}=c();return _({queryKey:["merchantRestaurants",e?.id],queryFn:async()=>{if(!e)return[];const{data:a,error:r}=await i.from("merchant_restaurants").select(`
          restaurant_id,
...
//# sourceMappingURL=useActivityParticipation-CZFVWdqc.js.map
