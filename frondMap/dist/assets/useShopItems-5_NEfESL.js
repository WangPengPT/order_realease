import{a as m,u as d,b as p}from"./vendor-query-BlSVl3IQ.js";import{y as h,Q as i,aF as n}from"./index-C1nN4O7Q.js";import{u as l}from"./vendor-i18n-DxKeo2S1.js";const q=()=>m({queryKey:["shop-items"],queryFn:async()=>{const{data:e,error:r}=await i.from("shop_items").select(`
          *,
          coupon_templates (
            id,
            title_zh,
...
//# sourceMappingURL=useShopItems-5_NEfESL.js.map
