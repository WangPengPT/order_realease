import{f as d,o as _,s as n,e as l,ag as p,ah as m,a4 as u}from"./index-DduPXw3p.js";const f=()=>{const{user:t}=d();return _({queryKey:["merchantRestaurants",t==null?void 0:t.id],queryFn:async()=>{if(!t)return[];const{data:e,error:r}=await n.from("merchant_restaurants").select(`
          restaurant_id,
