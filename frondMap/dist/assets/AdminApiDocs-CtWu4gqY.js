...
}`,section:"token-verify-example"})]})]});case"verify-token":return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx(i,{method:"POST"}),e.jsx("code",{className:"text-sm font-mono bg-muted px-2 py-1 rounded",children:"/verify-private-token"})]}),e.jsx("p",{className:"text-muted-foreground",children:"用 Token 换取用户资料，实现登录互通。外部餐厅网站调用此接口获取平台用户信息。"})]}),e.jsx(l,{className:"bg-green-500/5 border-green-500/20",children:e.jsx(n,{className:"pt-4",children:e.jsxs("div",{className:"flex items-start gap-3",children:[e.jsx(k,{className:"h-5 w-5 text-green-600 mt-0.5"}),e.jsxs("div",{className:"text-sm",children:[e.jsx("p",{className:"font-medium text-green-700 dark:text-green-400",children:"无需认证"}),e.jsx("p",{className:"text-muted-foreground mt-1",children:"此接口不需要 JWT 或 API Key，Token 本身就是凭证（5分钟时效）"})]})]})})}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-3",children:"使用场景"}),e.jsxs("div",{className:"bg-muted/50 p-4 rounded-lg text-sm space-y-2",children:[e.jsx("p",{children:'用户在平台点击"外卖/订台"按钮时，平台会生成一个短时效 Token 并拼接到外部 URL。'}),e.jsx("p",{children:"外部餐厅网站从 URL 中提取 Token，调用此接口验证并获取用户信息，实现免登录互通。"})]})]}),e.jsxs("div",{children:[e.jsxs("h4",{className:"font-medium mb-3 flex items-center gap-2",children:[e.jsx(c,{className:"h-4 w-4"}),"请求参数 (Body JSON)"]}),e.jsx("div",{className:"border rounded-lg overflow-hidden",children:e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:"w-full text-xs md:text-sm",children:[e.jsx("thead",{className:"bg-muted/50",children:e.jsxs("tr",{children:[e.jsx("th",{className:"text-left p-2 md:p-3 font-medium whitespace-nowrap w-28",children:"参数"}),e.jsx("th",{className:"text-left p-2 md:p-3 font-medium whitespace-nowrap w-28",children:"类型"}),e.jsx("th",{className:"text-left p-2 md:p-3 font-medium whitespace-nowrap w-16",children:"必填"}),e.jsx("th",{className:"text-left p-2 md:p-3 font-medium min-w-[100px]",children:"说明"})]})}),e.jsx("tbody",{children:e.jsxs("tr",{className:"border-t",children:[e.jsx("td",{className:"p-2 md:p-3",children:e.jsx("code",{className:"text-xs bg-muted px-1 rounded",children:"token"})}),e.jsx("td",{className:"p-2 md:p-3 text-muted-foreground whitespace-nowrap",children:"string"}),e.jsx("td",{className:"p-2 md:p-3",children:e.jsx(d,{variant:"outline",className:"text-xs",children:"是"})}),e.jsx("td",{className:"p-2 md:p-3 break-words",children:"从 URL 参数获取的 Token"})]})})]})})})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-3",children:"请求示例"}),e.jsx(s,{code:`curl -X POST "${r}/verify-private-token" \\
  -H "Content-Type: application/json" \\
  -d '{ "token": "eyJyaWQiOi...c2lnbmF0dXJl" }'`,section:"verify-token-example"})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-3",children:"成功响应"}),e.jsx(s,{code:`{
  "success": true,
  "user": {
    "id": "user-uuid",
    "display_name": "张三",
    "avatar_url": "https://xxx.supabase.co/storage/...",
    "email": "user@example.com",
    "phone": "+351912345678"
  },
  "restaurant_id": "restaurant-uuid"
}`,section:"verify-token-response"})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-3",children:"错误响应"}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-muted-foreground mb-1",children:"Token 无效或已过期 (401):"}),e.jsx(s,{code:'{ "success": false, "error": "Invalid or expired token" }',section:"verify-token-error-401"})]}),e.jsxs("div",{children:[e.jsx("p",{className:"text-sm text-muted-foreground mb-1",children:"用户不存在 (404):"}),e.jsx(s,{code:'{ "success": false, "error": "User not found" }',section:"verify-token-error-404"})]})]})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-3",children:"外部网站对接示例"}),e.jsx(s,{code:`// 1. 从 URL 获取 token
const token = new URLSearchParams(location.search).get('token');

// 2. 调用验证接口
const response = await fetch(
  '${r}/verify-private-token',
  {
    method: 'POST',
