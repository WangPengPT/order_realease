import{x as d,p as h,v as i,u as m,ac as p,af as l,ab as n}from"./index-B9cY5t1p.js";const _=()=>d({queryKey:["shop-items"],queryFn:async()=>{const{data:e,error:r}=await i.from("shop_items").select(`
          *,
          coupon_templates (
            id,
            title_zh,
