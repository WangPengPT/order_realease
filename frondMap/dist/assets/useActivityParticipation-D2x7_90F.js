import{k as d,p as _,s as n,i as p,ad as l,ae as m,a2 as u}from"./index-CJcx5ZXn.js";const f=()=>{const{user:t}=d();return _({queryKey:["merchantRestaurants",t==null?void 0:t.id],queryFn:async()=>{if(!t)return[];const{data:e,error:r}=await n.from("merchant_restaurants").select(`
          restaurant_id,
