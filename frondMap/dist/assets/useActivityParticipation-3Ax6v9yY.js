import{a as _,u as m,b as l}from"./vendor-query-BlSVl3IQ.js";import{i as o}from"./vendor-i18n-DxKeo2S1.js";import{o as c,s as i,n as y}from"./index-Do1W_89N.js";const f=()=>{const{user:e}=c();return _({queryKey:["merchantRestaurants",e?.id],queryFn:async()=>{if(!e)return[];const{data:a,error:r}=await i.from("merchant_restaurants").select(`
          restaurant_id,
...
//# sourceMappingURL=useActivityParticipation-3Ax6v9yY.js.map
