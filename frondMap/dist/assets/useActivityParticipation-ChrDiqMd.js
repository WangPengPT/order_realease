import{a as _,u as p,b as l}from"./vendor-query-BlSVl3IQ.js";import{i as o}from"./vendor-i18n-DxKeo2S1.js";import{n as c,s as i,m as y}from"./index-BcrfGQEh.js";const f=()=>{const{user:e}=c();return _({queryKey:["merchantRestaurants",e?.id],queryFn:async()=>{if(!e)return[];const{data:a,error:r}=await i.from("merchant_restaurants").select(`
          restaurant_id,
...
//# sourceMappingURL=useActivityParticipation-ChrDiqMd.js.map
