...
}`,section:"coupon-use-response"})]})]});case"private-token":return e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"flex items-center gap-3 mb-2",children:[e.jsx(i,{method:"POST"}),e.jsx("code",{className:"text-sm font-mono bg-muted px-2 py-1 rounded",children:"/generate-private-token"})]}),e.jsx("p",{className:"text-muted-foreground",children:"为已登录用户生成带有加密签名的私域导航 Token"})]}),e.jsx(l,{className:"bg-amber-500/5 border-amber-500/20",children:e.jsx(n,{className:"pt-4",children:e.jsxs("div",{className:"flex items-start gap-3",children:[e.jsx(p,{className:"h-5 w-5 text-amber-600 mt-0.5"}),e.jsxs("div",{className:"text-sm",children:[e.jsx("p",{className:"font-medium text-amber-700 dark:text-amber-400",children:"认证方式不同"}),e.jsx("p",{className:"text-muted-foreground mt-1",children:"此接口使用用户 JWT Token 认证，而非 API Key"})]})]})})}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-3",children:"功能说明"}),e.jsxs("div",{className:"grid gap-2 text-sm",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"h-1.5 w-1.5 rounded-full bg-primary"}),e.jsx("span",{children:"Token 有效期 5 分钟"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"h-1.5 w-1.5 rounded-full bg-primary"}),e.jsx("span",{children:"每次请求生成新 Token（含随机 nonce）"})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"h-1.5 w-1.5 rounded-full bg-primary"}),e.jsx("span",{children:"包含餐厅 ID 和用户 ID（用于收藏状态查询）"})]})]})]}),e.jsxs("div",{children:[e.jsx("h4",{className:"font-medium mb-3",children:"认证方式"}),e.jsx(s,{code:`Headers:
